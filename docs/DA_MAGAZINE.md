...
Après le premier essai, la main ne doit pas être étirée pour rejoindre artificiellement les deux bords. La dérivation v2 adapte la pose au téléphone `390 × 844` : quatre doigts saisissent le bord gauche, le pouce reste sur le bord droit et aucun doigt ne recouvre la surface active. Cette correction est intégrée, mais reste soumise à la revue artistique de l'utilisateur.
