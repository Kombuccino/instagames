...
function buildLineFuggPlan(game: InstagameDefinition): PlanProject {
  ...
  const screens: PlanScreen[] = [
    ...
    },
    {
      ...
      source: 'ChatGPT image generation · 17 septembre 2026', x: SCREEN_X.da, y: 420, image: `${LINEFUGG_REBIRTH_SOURCE_ROOT}/linefugg-rebirth-editorial-paper-master-390x850.png`, preview: 'proto', anchor: 'center',
    },
  ]
