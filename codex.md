...
Asset transport update, 2026-09-07: Codex with local repository access saves generated images directly under `public/assets/generated/<game-id>/...`, verifies and commits them. Private Drive → Actions remains the route for ChatGPT without local repository access. See `docs/ASSET_PIPELINE.md`; this newer decision overrides historical Drive-only descriptions below.
