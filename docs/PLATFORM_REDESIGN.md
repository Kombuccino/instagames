...
Le pilote `/?usr=moigod&lab=home-bis&entry=1` teste le raccord depuis la scène du métro sans modifier la Home principale. La main et le téléphone d'entrée se redressent et avancent ; un fondu noir et l'écran de chargement masquent le changement de scène. Le zoom se termine lorsque le CENTRE `390 × 662` remplit la hauteur PC : l'écran MASTER rouge reste plus haut que le viewport, exactement comme dans le schéma de cadrage, et sa coque sort en haut et en bas. Le téléphone se place simultanément à droite devant la chambre. Ce pilote reste expérimental jusqu'à validation visuelle.
