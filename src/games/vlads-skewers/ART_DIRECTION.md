...
Le percement a du poids : impact prolongé, orientation d'entrée, petite phrase de fin de vie, membres articulés en deux segments qui retombent, gerbe de jus et fragments. La pointe balaie une hitbox légèrement intérieure à la silhouette de chaque aliment. Le reste de la tige, la main et le bras ont leurs propres volumes : ils poussent l'aliment selon leur vitesse et leur direction, peuvent le relancer vers le haut, mais ne l'empalent jamais. Les aliments se séparent entre eux, retombent sous gravité et rebondissent aux murs. La pique et le nouveau bras authored restent rigides et fixes en taille ; le bras dépasse sous le stage lorsque Vlad monte, sans manche générée ou étirée. Seule la main accepte la prise. Le décalage entre le pointeur et le point saisi reste constant pendant tout le geste, y compris hors canvas et après saturation d'une butée ; la main ne suit jamais le pointeur au-delà de ses limites et reste visible en bas. Un clic raté déclenche un clignotement pixel de la main, interrompu dès une prise valide. Au relâchement, l'ensemble revient automatiquement en bas. La présentation monte en cinq paliers visuels et sonores — normal, ×2, ×3, ×4, ×5 `BRUTALITY!` — sans modifier le calcul de score. Une brochette complète reste exposée 1,65 seconde avant validation automatique pour laisser lire l'impact. Toute valeur de score supérieure reste intacte même si l'intensité artistique est plafonnée à ×5.
...
Le décor permanent ne contient aucune flamme figée. Des boucles raster pixel-art séparées, à silhouettes larges et cœur blanc-jaune, animent les six foyers, la salle embrasée au troisième plan et l'avant de la grille. Une densité franche d'étincelles allongées monte depuis tous les foyers, tandis que de grosses bouffées de fumée s'éteignent en hauteur pour donner la profondeur. Sur ordinateur, le jeu reprend exactement la largeur canonique de feed utilisée par LineFugg ; le décor `cover` se recadre dans cette surface sans élargir le gameplay.
