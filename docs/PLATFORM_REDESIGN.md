...
Le pilote `/?usr=moigod&lab=home-bis&entry=1` teste le raccord depuis la scène du métro sans modifier la Home principale. Sur PC, métro et chambre occupent exactement le même viewport large dès le départ : aucun cadre portrait ni bande noire ne réduit la première scène. La main et le téléphone restent une couche portrait indépendante au-dessus de ce décor. Au clic, une projection calculée depuis les quatre coins réels du verre redresse et rapproche l'ensemble ; un fondu noir et l'écran de chargement masquent le changement de pièce. Le raccord se termine lorsque le CENTRE `390 × 662` remplit la hauteur PC : l'écran MASTER reste plus haut que le viewport et sa coque sort en haut et en bas. Le téléphone se place simultanément à droite devant la chambre. Ce pilote reste expérimental jusqu'à validation visuelle.
