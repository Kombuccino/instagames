...
### Étalon validé — TetraMindFck, 12 septembre 2026

Les trois masters TetraMindFck acceptés sont les références concrètes de qualité pour les familles A/B/C :

- `public/assets/generated/tetramindfck/welcome/variants/masters/v1-pulp-euro-master.png` ;
- `public/assets/generated/tetramindfck/welcome/variants/masters/v2-micro-euro-master.png` ;
- `public/assets/generated/tetramindfck/welcome/variants/masters/v3-graphic-poster-master.png`.

Leur force ne vient ni des seules étiquettes rétro, ni de la patine, ni de la répétition des pièces Tetra. Chaque cover s'engage dans une tradition d'image, une idée dominante et une hiérarchie propres. Le personnage est expressif plutôt qu'embelli, le titre appartient à la composition, les détails se concentrent autour de l'événement et des zones plus calmes préservent l'échelle. Les traces d'outil et d'impression restent spécifiques au médium choisi au lieu de devenir un filtre de bruit générique.
...
Le 12 septembre 2026, l'utilisateur a confirmé comme références de style **toutes les variantes de la première rangée** de `GFX/crea-chatgpt/game/ChatGPT Image 5 sept. 2026, 19_27_48 (1).png`, ainsi que sa variante `PUB 90s`. Cette validation porte sur leur écriture d'auteur et leur diversité, pas sur les anciens slogans, CTA, logos ou textes français de la planche. Les trois premiers masters statiques ont été acceptés comme fichiers de production, puis l'édition japonaise recréée a été explicitement validée comme quatrième master indépendant le même jour.
...
**Grammaire de référence TetraMindFck :** grandes masses peintes et encrées à la main ; titre anguleux comme découpé ; brosse, gouache ou empâtement tactiles ; explosion diagonale concentrée sur un visage imparfait et très expressif ; couleurs franches des pièces sur un bleu-noir profond. Les fragments secondaires restent subordonnés au visage. Refuser le réalisme cinématique lisse, la symétrie héroïque, l'embellissement du personnage et le faux vieillissement posé uniformément sur un rendu moderne.
...
**Grammaire de référence TetraMindFck :** champs crème, rouge, bleu et noir de sérigraphie/offset ; titre utilisé comme architecture ; silhouette humaine fusionnée avec de grandes masses graphiques ; pièces Tetra comme métaphore unique ; vide fort et rupture d'échelle. Usure d'encre et patine du papier peuvent vivre à l'intérieur de l'image, mais la cover reste plein cadre. Refuser l'ornement gratuit, les alphabets étrangers arbitraires, les cadres grunge génériques et les coins abîmés.
