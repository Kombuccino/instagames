...
Sur écran étendu, le téléphone au repos se place entre le lecteur au casque et le voyageur plus âgé. Le cadrage portrait vise le même intervalle visuel, sans laisser le téléphone dériver vers la gauche. Les huit bras d'entrée dérivent des mains et téléphones d'origine sans les redessiner. La main, le téléphone, le poignet, les accessoires et les 941 premiers pixels restent identiques à leur source. La manche ajoutée doit prolonger directement la texture raster propre au vêtement, sans changement visible de palette ou d'échelle des facettes ; elle conserve une largeur crédible, suit l'angle existant puis quitte naturellement le cadre par le bas. Elle ne doit jamais s'élargir progressivement vers le bord. Une manche commune recolorée, une forme CSS, un aplat ou une copie d'un autre bras ne constitue pas un raccord acceptable.
