...
- [ ] Ajouter la gestion visible des amis (recherche/ajout/acceptation/suppression/blocage) lorsque le système de comptes est prêt. Le schéma et le filtre FRIENDS des ladders existent déjà ; ne pas simuler des amis par pseudo.
...
- [ ] Refaire plus tard le panneau Core de Game Over, jugé très moche. Conserver le contrat fonctionnel : gameplay final gelé derrière le résultat, score/rang réels, replay, leaderboard et retour à la cover ; ne pas réutiliser la jaquette comme fond.
