...
| Créer / corriger une interface ou une entrée MiniFugg | [DA UI](DA_UI.md) ou [DA Welcome](DA_WELCOME.md), [DA commune](DA_CORE.md), [Zones MiniFugg](MINIFUGG_ZONES.md), [validation plateforme](PLATFORM_VISUAL_VALIDATION.md) | Réutilisation des références, composants et zones canoniques |
